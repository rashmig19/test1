...
from llm.llm import set_llm_telemetry, get_llm_telemetry
...
from services.case_rest import (
...
METRICS_XLSX_PATH = Path(settings.METRICS_XLSX_PATH)
METRICS_MASTER_CSV = Path(settings.METRICS_MASTER_CSV)
METRICS_QUEUE_CSV = Path(settings.METRICS_QUEUE_CSV)

# Store per-session totals in-memory (thread_id -> totals dict)
SESSION_TOKEN_TOTALS: Dict[str, Dict[str, float]] = {}
